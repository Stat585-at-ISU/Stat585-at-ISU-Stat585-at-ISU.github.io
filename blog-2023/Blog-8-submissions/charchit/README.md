...
It was good. I enjoyed working with github. It was fairly easy to build
a website on github. However, creating a good website seems a bit
challenging. There needs to be a human element which people would like
to interact with and easy to use.I found a lot of tutorials on youtube
about it too. I will most likely use it to publish my work in the future
when I am close to graduation. Thanks for introducing this in the class.
