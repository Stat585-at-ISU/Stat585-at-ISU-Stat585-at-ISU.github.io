...
“\_site.yml”, other pages, and rendering went pretty well. I had a
challenge regarding the setting (main branch and docs), and pushing
changes to the Github. I needed to arrange the setting and push the
changes manually and it worked finally.
