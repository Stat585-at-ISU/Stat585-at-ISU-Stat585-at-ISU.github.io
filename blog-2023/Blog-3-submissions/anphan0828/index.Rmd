...
And there we have it, the book has been successfully built entirely from R, with the help of LaTeX and some Cpp code. Now the errors feel less frustrating to deal with, I guess I have encountered around 10% of all possible errors `r emo::ji("smile")` `r emo::ji("hooray")` `r emo::ji("hooray")` `r emo::ji("hooray")`!
