...
I looked up the note on Google and found a [Stack Overflow post](https://stackoverflow.com/questions/48955103/non-standard-file-directory-found-at-top-level-readme-rmd-persists-even-after) describing a similar issue. I then resolved the note by adding `^presslog_amespd_2023-03-07\.pdf$` to the `.Rbuildignore` file.
