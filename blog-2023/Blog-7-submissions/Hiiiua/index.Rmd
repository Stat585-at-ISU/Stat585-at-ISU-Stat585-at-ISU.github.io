...
I decide to use `CC BY 4.0`, which means it's free to share and adapt as long as providing the link.
```{r}
...
*My answer:*
I agree with the first ChatGPT answer that this is a complicated and can vary depending on the specific circumstances.       
