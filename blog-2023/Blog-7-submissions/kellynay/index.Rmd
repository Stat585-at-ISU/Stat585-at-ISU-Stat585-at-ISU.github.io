...
- Licenses involved for package Team3:
MIT + file LICENSE

- Are all of these dependencies required?
Not all these dependencies are required because "RCurl" was just another method used to download files from the URL address. Thus, "RCurl" is not required.

- Under which license should this blog post be published?
I am posting this blog under R's current's license because I would not mind sharing this this publicly.
