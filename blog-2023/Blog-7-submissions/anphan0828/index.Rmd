...
R operates under many licenses, including `GPL-2 | GPL-3` (General Public License, version 2 and 3), all of which are listed [here](https://www.r-project.org/Licenses/) or in [Licensing R](https://thinkr-open.github.io/licensing-r/rworld.html#package-licenses). 

ggplot2 is MIT-licensed as stated on [CRAN documentation](https://cran.r-project.org/web/packages/ggplot2/index.html)

### What are the dependencies of the package you made?

Read through [chapter 5.2 of Licensing R](https://thinkr-open.github.io/licensing-r/practical.html#dependencies-exploration). 
...
- `tabulizer` also needs to be imported (as shown in **plogdeps**), but this package is not on CRAN so it is not found in CRAN **pkgdb**. `tabulizer` is also under MIT license as shown in this [documentation](https://docs.ropensci.org/tabulizer/)
