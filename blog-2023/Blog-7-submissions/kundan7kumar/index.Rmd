...
**Solution:**
No, We cannot publish a package under the MIT license, as the GPL-3 license says that any derivative work which includes a work that has links or is dependent on GPL-3 should come under its license, so R-package should not come under the MIT license. It should come under a GPL-3 license.
