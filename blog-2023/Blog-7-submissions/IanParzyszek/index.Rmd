...
'dplyr' uses an MIT license
'tabulizer'uses an MIT license
'lubridate' uses a  GPL-2 | GPL-3 license
'readr' uses an MIT license 
'stringr' uses an MIT license
...
Yes? The legality is really unclear, is from what I understood.
